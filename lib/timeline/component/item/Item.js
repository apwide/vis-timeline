 ...
 */
  ...
  _repaintOnItemUpdateTimeTooltip(anchor) {
    ...
    const isDragging = this.parent.itemSet.touchParams.itemIsDragging

    if ((this.selected || isDragging) && editable && !this.dom.onItemUpdateTimeTooltip) {
    ...
    } else if (!this.selected && !isDragging && this.dom.onItemUpdateTimeTooltip) {
      // remove button
